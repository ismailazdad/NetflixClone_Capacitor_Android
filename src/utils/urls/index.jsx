...
const urls = {
    ...
    findSimilarById : API_URL+'movie/{id}/similar?api_key='+API_KEY+'&page=1&language=',
    findRecommendedById : API_URL+'movie/{id}/recommendations?api_key='+API_KEY+'&page=1&language=',
